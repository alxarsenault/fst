...
do
    ...
    function table.load( sfile )
       ...
       local tables = (ftables and ftables()) or {}
       for idx = 1,#tables do
          local tolinki = {}
...
print("shared_cache_path", shared_cache_path)
shared = table.load(shared_cache_path) or {};

function save_shared_cache()
    table.save(shared, shared_cache_path)
end