...
class BenchmarkFamilies {
 public:
  ...
  static BenchmarkFamilies* CreateInstance();
...
BenchmarkFamilies*& BenchmarkFamilies::GetInstance() {
  static BenchmarkFamilies* instance = nullptr;
  return instance;
}


BenchmarkFamilies* BenchmarkFamilies::CreateInstance() {
  GetInstance() = new BenchmarkFamilies();
  return GetInstance();
}

void BenchmarkFamilies::Finalize() {
  delete GetInstance();
  GetInstance() = nullptr;
}
...
void BenchmarkFamilies::ClearBenchmarks() {
  ...
  families_ = std::vector<std::unique_ptr<Benchmark>>();
}
...
void InitRegisteredBenchmarks() {
  internal::BenchmarkFamilies::CreateInstance();
  //ptr = new internal::BenchmarkFamilies;
}

void ClearRegisteredBenchmarks() {
  internal::BenchmarkFamilies::GetInstance()->ClearBenchmarks();
  internal::BenchmarkFamilies::Finalize();
}
