...
function(prefix_clangformat_setup prefix)
    ...
    list(REMOVE_ITEM clangformat_sources "${CMAKE_CURRENT_SOURCE_DIR}/src/rpmalloc.h")

    add_custom_target(
        ${prefix}_clangformat COMMAND ${CLANGFORMAT_EXECUTABLE} -verbose -style=file -i ${clangformat_sources}
        WORKING_DIRECTORY ${CMAKE_SOURCE_DIR} COMMENT "Formatting ${prefix} with ${CLANGFORMAT_EXECUTABLE} ...")

    if(TARGET clangformat)
        add_dependencies(clangformat ${prefix}_clangformat)
    else()
        add_custom_target(clangformat DEPENDS ${prefix}_clangformat)
        set_target_properties(${prefix}_clangformat PROPERTIES FOLDER tools)
    endif()
endfunction()
...
function(target_clangformat_setup target)
    ...
    set_target_properties(clangformat PROPERTIES FOLDER tools)
endfunction()
